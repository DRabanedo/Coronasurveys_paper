...
################################################################################
file_name = str_c("Simulation_subpopulationnumber_notdisjoint_sw_sir_pop2_", seed_sim,".csv")
...
################################################################################
file_name_disjoint = str_c("Simulation_subpopulationnumber_disjoint_sw_sir_pop2_", seed_sim,".csv")
...
plot_name = str_c("Network_numbersubpopulations_sir_sw_pop2_", seed, ".png")
