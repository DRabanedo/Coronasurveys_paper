...
################################################################################
file_name = str_c("Simulation_subpopulationnumber_notdisjoint_d_uniform_sw_pop2_", seed_sim,".csv")
...
plot_name = str_c("Network_numbersubpopulations_d_uniform_sw_pop2_", seed, ".png")
