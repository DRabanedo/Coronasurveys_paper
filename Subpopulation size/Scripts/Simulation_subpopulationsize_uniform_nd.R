...
################################################################################
file_name = str_c("Simulations_subpopulationsize_notdisjoint_d_uniform_sw_", seed_sim,".csv")
...
plot_name = str_c("Simulations_subpopulationsize_notdisjoint_d_uniform_sw_", seed, ".png")
