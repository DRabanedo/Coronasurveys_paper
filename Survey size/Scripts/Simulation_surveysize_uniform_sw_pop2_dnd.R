...
################################################################################
file_name = str_c("Simulation_surveysize_notdisjoint_uniform_sw_pop2", seed_sim,".csv")
...
################################################################################
file_name_disjoint = str_c("Simulation_surveysize_disjoint_uniform_sw_pop2", seed_sim,".csv")
