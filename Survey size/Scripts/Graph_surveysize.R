...
plot_name = str_c("Simulation_surveysize_", seed_number, "_notdisjoint_median.png")
sub_title = str_c("Not disjoint populations plot, seed ", seed_number)
...
plot_name = str_c("Simulation_surveysize_", seed_number, "_disjoint_median.png")
sub_title = str_c("Disjoint populations plot, seed ", seed_number)
...
plot_name = str_c("Simulation_surveysize_", seed_number, "_total_median.png")
sub_title = str_c("Disjoint & not disjoint populations plot, seed ", seed_number)
