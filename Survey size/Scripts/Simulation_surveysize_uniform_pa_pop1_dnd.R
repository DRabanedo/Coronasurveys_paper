...
################################################################################
file_name = str_c("Simulation_surveysize_notdisjoint_uniform_pa_pop1_", seed_sim,".csv")
...
################################################################################
file_name_disjoint = str_c("Simulation_surveysize_disjoint_uniform_pa_pop1_", seed_sim,".csv")
...
plot_name = str_c("Network_surveysize_uniform_pa_", seed, ".png")
