...
################################################################################
file_name = str_c("Simulation_subpopulationmemoryfactor_notdisjoint_uniform_sw_pop1_", seed_sim, ".csv")
...
################################################################################
file_name_disjoint = str_c("Simulation_subpopulationmemoryfactor_disjoint_uniform_sw_pop1_", seed_sim,".csv")
...
plot_name = str_c("Network_subpopulationmemoryfactor_uniform_sw_pop1_", seed, ".png")
