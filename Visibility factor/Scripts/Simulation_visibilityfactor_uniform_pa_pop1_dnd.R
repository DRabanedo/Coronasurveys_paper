...
for (w in 1:length(parameters)) {
  ...
  population_buc  = cbind(population_buc, gen_Subpopulation_memoryfactor(population_buc, Mhp_vis, sub_memory_factor, net_pa) )
  ...
  population_disjoint_buc  = cbind(population_disjoint_buc, gen_Subpopulation_memoryfactor(population_disjoint_buc, Mhp_vis, sub_memory_factor, net_pa) )
...
################################################################################
file_name = str_c("Simulation_visibilityfactor_notdisjoint_uniform_pa_pop1_", seed_sim, ".csv")
...
################################################################################
file_name_disjoint = str_c("Simulation_visibilityfactor_disjoint_uniform_pa_pop1_", seed_sim,".csv")
...
################################################################################
file_name_disjoint = str_c("Simulation_visibilityfactor_disjoint_vfe_matrix_uniform_pa_pop1_", seed_sim,".csv")
...
################################################################################
file_name_disjoint = str_c("Simulation_visibilityfactor_notdisjoint_vfe_matrix_uniform_pa_pop1_", seed_sim,".csv")
...
plot_name = str_c("Network_visibilityfactor_pa_", seed, ".png")

png(filename = plot_name,
    width = 1000, height = 1000)
net_analysisv2(net_pa, Population)
dev.off()
