...
################################################################################
file_name = str_c("Simulation_visibilityfactor_notdisjoint_uniform_sw_pop2_", seed_sim, ".csv")
...
################################################################################
file_name_disjoint = str_c("Simulation_visibilityfactor_disjoint_uniform_sw_pop2_", seed_sim,".csv")
...
################################################################################
file_name_disjoint = str_c("Simulation_visibilityfactor_disjoint_vfe_matrix_uniform_sw_pop2_", seed_sim,".csv")
...
################################################################################
file_name_disjoint = str_c("Simulation_visibilityfactor_notdisjoint_vfe_matrix_uniform_sw_pop2_", seed_sim,".csv")
